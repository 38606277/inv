...
@XmlType(name = "OA_PageInquiryDepartmentInfoSrvResponse", propOrder = {
    "errorFlag",
    "errorMessage",
    "totalrecord",
    "totalpage",
    ...
    "currentpage",
    "instanceid",
    "oaPageInquiryDepartmentInfoSrvOutputCollection"
})
public class OAPageInquiryDepartmentInfoSrvResponse {
    ...
    @XmlElement(name = "OA_PageInquiryDepartmentInfoSrvOutputCollection", required = true)
    protected OAPageInquiryDepartmentInfoSrvOutputCollection oaPageInquiryDepartmentInfoSrvOutputCollection;
    ...
    public OAPageInquiryDepartmentInfoSrvOutputCollection getOAPageInquiryDepartmentInfoSrvOutputCollection() {
        return oaPageInquiryDepartmentInfoSrvOutputCollection;
    }

    public void setOAPageInquiryDepartmentInfoSrvOutputCollection(OAPageInquiryDepartmentInfoSrvOutputCollection value) {
        this.oaPageInquiryDepartmentInfoSrvOutputCollection = value;
    }
